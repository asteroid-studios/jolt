...
extension JoltTypographyExtensions on BuildContext {
  TextStyleMapping get textStyle => TextStyleMapping(Theme.of(this));
}

/// This mapping is primarily meant to only reveal 2021 text-styles
