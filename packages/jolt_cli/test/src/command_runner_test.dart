...
import 'package:jolt_cli/src/command_runner.dart';
...
void main() {
  group('JoltCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late JoltCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = JoltCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = JoltCliCommandRunner();
