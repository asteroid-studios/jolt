...
Each widget needs two files:
 ...
 - `widget_style.dart` - Defines the modifiable properties of the widget

Replace widget appropriately with the name of your widget.

### Implement the style file

Always use [freezed](https://pub.dev/packages/freezed) when making a new Style class. You also need to implement the Style class.

Freezed will give you a copyWith method, as well as equality. You will need to implement the merge method yourself.

``` dart filename="widget_style.dart"
