...
import {  PencilCircle, RadioButton } from "@phosphor-icons/react";
...
<Cards>
  <Card icon={<PencilCircle weight="duotone" size='32' />}  title="Creating a custom widget" href="/contributing/creating_a_widget" />
</Cards>
